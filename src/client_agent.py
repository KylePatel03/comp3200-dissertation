...
class ClientAgent(Agent):
    ...
    def produce_weights(self, message: Message) -> Message:
        ...
        #simulated_time += directory.latency_dict[self.name][edge_server.name]
        ...
        #msg = Message(sender_name=self.name, recipient_name=directory.main_server.name, body=body)
        #Send a message to the EdgeServer to produce local weight update
        msg = Message(sender_name=self.name, recipient_name=edge_server.name, body=body)
